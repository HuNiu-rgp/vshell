export default {
  ...
  tab: {
    ...
    openLocalHere: 'Open Local Here',
    openCurrentDir: 'Open Current Directory (⌘F)',
    openCurrentDirFailed: 'Failed to open current directory: {error}',
    localOnly: 'Current directory actions are only available for local terminals',
    close: 'Close',
  ...
  sftp: {
    ...
    saved: 'File saved to the server',
    saveFailed: 'Save failed: {error}',
    renamed: 'Renamed successfully',
    renameFailed: 'Rename failed: {error}',
    invalidName: 'Enter a valid name without /',
    permissionsSaved: 'Permissions updated',
    permissionsFailed: 'Failed to update permissions: {error}',
    unsavedTitle: 'Unsaved Changes',
    unsavedContent: 'This file has unsaved changes. Discard them?',
    discard: 'Discard',
